...
class PostgreSQLConnection:
    ...
    def update_user(self, id=None, name=None, area=None, job_description=None, role=None, salary=None, is_active=None, last_evaluation=None):
        if not self.conn:
            print('Você não está conectado')
            return None
        ...
        try:
            ...
            print('Não foi possível atualziar o user: ', e)
